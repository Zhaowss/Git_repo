...
![image-20230906141204942](assets/image-20230906141204942.png)
...
1. git add (工作区 --> 暂存区)
   ...
   ![image-20230906141605733](assets/image-20230906141605733.png)

2. git commit (暂存区 --> 本地仓库)

   ![image-20230906141547518](assets/image-20230906141547518.png)

#### 3.3.1、*查看修改的状态(status)

- 作用：查看的修改的状态（暂存区、工作区）
- 命令形式：`git status`
- ![image-20230906141423685](assets/image-20230906141423685.png)
